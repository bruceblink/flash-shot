...
本次复审基于 `main` 提交 `3042918`（2026-09-06）以及 workspace 中的五个 crate。复审范围包括 Cargo
...
- 此前 `v0.1.2` 已发布，发布资产、安装器、便携包、manifest 和版本事实保持一致；已有 Windows 单显示器
...
| 编号 | 主线切片 | 状态 | 说明 |
| --- | --- | --- | --- |
| A | `v0.1.3` 发布基线 | 准备发布 | 当前源码、版本号、安装器、便携包、manifest 和发布说明须在同一标签上核对 |
