    ...
    pub fn for_mode(mode: ThemeMode) -> Self {
        match mode {
            ThemeMode::Dark => Self {
                ...
                toolbar_surface: Hsla::from(rgb(0x171717)),
                toolbar_elevated: Hsla::from(rgb(0x222222)),
                toolbar_border: Hsla::from(rgb(0x3a3a3a)),
                toolbar_hover: Hsla::from(rgb(0x2c2c2c)),
                toolbar_active: Hsla::from(rgb(0x1f6feb)),
                toolbar_focus: Hsla::from(rgb(0x78a9ff)),
