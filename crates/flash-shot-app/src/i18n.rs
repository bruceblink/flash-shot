...
pub enum UiText {
    ...
    AnnotationTextSize,
    AnnotationOpacity,
    AnnotationOpacityValue,
    AnnotationWidthValue,
    AnnotationTextSizeValue,
    AnnotationWidthLabel,
    AnnotationTextSizeLabel,
    AnnotationOpacityLabel,
    ...
    OverlayShapeGroup,
    OverlayShapeGroupTooltip,
    OverlayLineGroup,
    OverlayLineGroupTooltip,
    OverlayObscureGroup,
    OverlayObscureGroupTooltip,
    OverlaySelected,
    OverlayDelete,
    OverlayEditText,
    OverlayDuplicate,
...
impl UiText {
    const fn english(self) -> &'static str {
        match self {
            ...
            Self::AnnotationNumberValue => "{value}",
            ...
            Self::AnnotationOpacityValue => "{percent}%",
            Self::AnnotationWidthValue => "{width}",
            Self::AnnotationTextSizeValue => "{size}",
            Self::AnnotationWidthLabel => "Line width",
            Self::AnnotationTextSizeLabel => "Text size",
            Self::AnnotationOpacityLabel => "Opacity",
            ...
            Self::OverlayLayerLabel => "{position}. {kind}",
            ...
            Self::OverlayShapeGroupTooltip => "Choose a shape annotation",
            Self::OverlayLineGroup => "Line",
            Self::OverlayLineGroupTooltip => "Choose a line annotation",
            Self::OverlayObscureGroup => "Obscure",
            Self::OverlayObscureGroupTooltip => "Choose a blur or mosaic tool",
            ...
            Self::LibraryFileNamePattern => "{prefix}+time+UUIDv7",
            ...
            Self::LibraryEntryLabel => "{name} - {source} - {time}",
    ...
    const fn simplified_chinese(self) -> &'static str {
        match self {
            ...
            Self::AnnotationWidthValue => "{width}",
            Self::AnnotationTextSizeValue => "{size}",
            Self::AnnotationWidthLabel => "线宽",
            Self::AnnotationTextSizeLabel => "文字大小",
            Self::AnnotationOpacityLabel => "不透明度",
            ...
            Self::OverlayShapeGroupTooltip => "选择形状标注类型",
            Self::OverlayLineGroup => "线条",
            Self::OverlayLineGroupTooltip => "选择线条标注类型",
            Self::OverlayObscureGroup => "遮挡",
            Self::OverlayObscureGroupTooltip => "选择模糊或马赛克工具",
